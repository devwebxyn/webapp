...
import { ContactDeveloperModal } from '../components/dashboard/settings/ContactDeveloperModal';
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex-shrink-0">
              {!isApiReady || (isLoading && !isLinked) ? (
                <button
                  disabled
                  className="bg-neutral-600 text-background font-bold px-4 py-2 rounded-md flex items-center gap-2 cursor-wait w-full sm:w-auto justify-center"
                >
                ...
                <button
                  ...
                  className="bg-red-500/90 text-white font-semibold px-4 py-2 rounded-md flex items-center gap-2 hover:bg-red-600 transition-colors w-full sm:w-auto justify-center"
                >
                ...
                <button
                  ...
                  className="bg-primary text-background font-bold px-4 py-2 rounded-md flex items-center gap-2 hover:bg-primary/80 transition-colors w-full sm:w-auto justify-center"
                >
